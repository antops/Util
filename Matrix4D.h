...
#ifndef MATRIX4D_H
#define MATRIX4D_H
//ADD theta-phi generated Matrix by MingJin
...
public:
	...
	static  Matrix4D getRotateMatrix(double angle, double x, double y, double z);
	static  Matrix4D getRotateMatrixRad(double theta, double phi);	
	static  Matrix4D getInvRotateMatrixRad(double theta, double phi);
